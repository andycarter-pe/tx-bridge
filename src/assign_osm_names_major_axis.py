...
def fn_assign_osm_names_major_axis(str_aoi_shp_path,str_mjr_axis_shp_path,str_output_dir,flt_perct_on_line,flt_offset):
    ...
    try:
        ...
        print('OSM rail data not found')
        
    if b_got_drive and b_got_rail:
    ...
    if b_got_rail and not b_got_drive:
        # rail only
        gdf_edges_road_rail = gdf_edges_rail
    ...
    if b_got_rail or b_got_drive:
        ...
        print('ERROR: No OSM data found. (rail or road)')
# ..........................................................

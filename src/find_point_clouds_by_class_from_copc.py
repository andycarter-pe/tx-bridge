...
def fn_get_las_tiles(gdf_current_tile):
    ...
    str_input_copc_path = gdf_current_tile.iloc[0]['copc_path']
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def fn_point_clouds_by_class_from_copc(str_input_path,
                                       str_output_dir,
                                       str_input_copc_file,
                                       int_class,
                                       int_buffer,
    ...
    print("|               AND A PROVIDED COPC POINT CLOUD FILE              |")
    ...
    print("  ---(f) INPUT COPC FILE PATH: " + str_input_copc_file)
...
if __name__ == '__main__':
    ...
    # TODO - 2024.07.24 - Need to add number of desired processors?
    ...
    parser.add_argument('-f',
                        dest = "str_input_copc_file",
                        help=r'REQUIRED: path to the input COPC point cloud Example: D:\003_north_and_central_texas\000_copc\003_br_st1_merge.copc.laz',
                        required=True,
                        metavar='FILE',
                        type=lambda x: is_valid_file(parser, x))
    ...
    str_input_copc_file = args['str_input_copc_file']
    ...
    fn_point_clouds_by_class_from_copc(str_input_path,
                                       str_output_dir,
                                       str_input_copc_file,
                                       int_class,
                                       int_buffer,

...
# --------------------------------------------------------
def fn_assign_feature_id_to_mjr_axis(str_input_dir, str_national_dataset_dir):
    ...
    Args:
        ...
        str_national_dataset_dir: path to National Water Model input datasets
    ...
    str_nwm_flowline_geopkg_path = os.path.join(str_national_dataset_dir,'nwm_flows.gpkg')
    str_netcdf_path = os.path.join(str_national_dataset_dir,'nwm_v20_recurrence_flows.nc')
...
if __name__ == '__main__':
    ...
    # TODO - Note the hard coded path to the default directory for national data set - 2022.11.08
    parser.add_argument('-n',
                        dest = "str_national_dataset_dir",
                        help=r'OPTIONAL: directory to national water model input datasets: Example: G:\X-NWS\X-National_Datasets',
                        required=False,
                        default=r'G:\X-NWS\X-National_Datasets',
                        metavar='DIR',
                        type=str)
    ...
    str_national_dataset_dir = args['str_national_dataset_dir']
    ...
    print("  ---[n]   Optional: PATH TO NATIONAL DATASETS: " + str_national_dataset_dir)
    print("===================================================================")
